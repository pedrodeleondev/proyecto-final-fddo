...
4.- Cuando la infraestructura esté lista, te debes conectar a la instancia creada, para volver a clonar el repositorio y entras de nuevo a la carpeta del repositorio, una vez dentro te debes dirigir a la carpeta aplicacionWeb.
